        ...
        <>
            ...
            <div>
                <div className="container-xl grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-12 py-16 text-white items-center relative z-10">
                    <div className="w-full h-96 overflow-hidden bg-cover bg-center rounded-md" style={{ backgroundImage: `url('/imgs/spidey.webp')` }}></div>
                    <div className="">
                        <h1 className="font-semibold text-4xl mb-7 text-[#FF5F2A]">Spider-Man 2</h1>
                        <p className="mb-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio aut temporibus iusto doloremque amet numquam dolores maxime saepe pariatur voluptas</p>
